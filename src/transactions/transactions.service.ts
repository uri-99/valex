...
export class TransactionsService {
    ...
    async apiCall(fromDate: Date = new Date(-8640000000000000), toDate: Date = new Date(8640000000000000)): Promise<Array<Transaction>> {
    ...
    async getBalanceByDate(fromDate: Date, toDate: Date): Promise<number> {

        let transactions = await this.apiCall(fromDate, toDate);

        let ethInPeriod = transactions.reduce(function (tot, record) {
